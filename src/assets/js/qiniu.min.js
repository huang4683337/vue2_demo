	...
	return function(t) {
		...
		t.exports = function(t, e, n, d, v, y, m) {
			...
			var g, b, _, w = function(t) {
				...
				O = P || w(v),
				M = v ? S ? w("entries") : O : void 0,
				U = "Array" == e && C.entries || P;
			if(U && (_ = f(U.call(new t))) !== Object.prototype && _.next && (c(_, x, !0), r || "function" == typeof _[l] || u(_, l, h)), S && P && "values" !== P.name && (k = !0, O = function() {
					return P.call(this)
				}), r && !m || !p && !k && C[l] || u(C, l, O), s[e] = O, s[x] = h, v)
				if(g = {
						values: S ? O : w("values"),
						keys: y ? O : w("keys"),
						entries: M
		...
		var r, o, i, u, s = n(16),
					...
					g(function() {
						for(var r = t._v, o = 1 == t._s, i = 0; n.length > i;) ! function(e) {
							var n, i, u, s = o ? e.ok : e.fail,
								...
								f = e.domain;
							try {
								s ? (o || (2 == t._h && I(t), t._h = 1), !0 === s ? n = r : (f && f.enter(), n = s(r), f && (f.exit(), u = !0)), n === e.promise ? c(x("Promise-chain cycle")) : (i = U(n)) ? i.call(n, a, c) : a(n)) : c(r)
							} catch(t) {
								f && !u && f.exit(), c(t)
							}
						}(n[i++]);
			...
			I = function(t) {
				m.call(a, function() {
					var e;
					C ? S.emit("rejectionHandled", t) : (e = a.onrejectionhandled) && e({
						promise: t,
						reason: t._v
					})
				})
		...
		M || (k = function(t) {
			...
			Promise: k
		}), n(21)(k, "Promise"), n(78)("Promise"), u = n(2).Promise, l(l.S + l.F * !M, "Promise", {
			reject: function(t) {
				var e = O(this);
		...
		var r = n(0),
			...
			W = function(t, e, n) {
				return t === z && W(B, e, n), g(t), e = w(e, !0), g(n), o(q, e) ? (n.enumerable ? (o(t, F) && t[F][e] && (t[F][e] = !1), n = S(n, {
					enumerable: x(0, !1)
				})) : (o(t, F) || U(t, F, x(1, {})), t[F][e] = !0), G(t, e, n)) : U(t, e, n)
			},
			X = function(t, e) {
				g(t);
